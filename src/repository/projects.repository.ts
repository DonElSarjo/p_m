...
export const updateProject = async (projectId: number, project_desc: string, project_status: ProjectStatus) => {
...
export const softDeleteProject = async (projectId: number) => {
    return await prisma.projects.update({
