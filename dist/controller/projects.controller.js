...
const projectRepository = __importStar(require("../repository/projects.repository"));
const prisma = new client_1.PrismaClient();
// Gets all projects
const getAllProjects = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const projects = yield projectRepository.getAllProjects();
        res.json(projects);
    }
    catch (error) {
...
const getProjectById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const project = yield projectRepository.getProjectById(parseInt(id));
        if (!project) {
